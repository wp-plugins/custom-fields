...
class CF_Page_Field_Taxo{
	...
	function submenu(){
		add_submenu_page( $this->pt->id_menu, $this->pt->taxo->labels->name, $this->pt->taxo->labels->name, 'manage_options', 'custom_fields_taxo-' . $this->pt->post_type, array(&$this, 'displayAdminFormFields') );
	}
